  ...
  return (
    <AuthOverlayFrame onClose={onClose} className="max-w-lg">
      <div className="overflow-hidden rounded-[24px] border border-zinc-200 bg-white">
        <div className="flex items-center gap-4 border-b border-zinc-200 px-5 py-5">
          {showSettings ? (
            <button
              ...
              className="rounded-full p-1 text-zinc-500 transition-colors hover:text-zinc-900"
            >
        ...
        {showSettings ? (
          <div className="max-h-[60vh] overflow-y-auto bg-[#fcfaf4] p-5">
            <SettingsSections
              locale={locale}
              imageUrl={imageUrl}
              name={displayName}
          ...
          <div className="divide-y divide-zinc-100">
            <button
              type="button"
              className="flex w-full items-center gap-3 px-5 py-4 text-left text-zinc-800 transition-colors hover:bg-zinc-50"
